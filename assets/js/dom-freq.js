...
const topTarget = document.querySelector("#top-char");
topTarget.textContent = `가장 자주 나온 글자: ${targets[maxIdx]}(${counts[maxIdx]}번)`;
topTarget.style.fontWeight = "bold";
topTarget.style.color = "crimson";